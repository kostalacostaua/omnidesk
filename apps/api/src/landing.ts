...
var T = {
  uk: {
    'nav.channels':'Канали','nav.how':'Як працює','nav.zoho':'Zoho CRM','nav.price':'Ціна',
    'nav.signin':'Увійти','nav.try':'Спробувати',
    'hero.badge':'Скринька для Zoho CRM',
    'hero.h1a':'Усі переписки з клієнтами —','hero.h1b':'в одному вікні',
    'hero.lead':'Telegram, Instagram Direct і Messenger приходять в одну скриньку. Історія листування стоїть поруч з карткою клієнта в Zoho CRM, тому менеджер не шукає, хто це писав і про що домовлялися.',
    ...
    'zh.h':'Переписка поруч з карткою клієнта','zh.lead':'Rozmovio стає віджетом у Zoho CRM. Менеджер бачить листування там, де й так працює — у картці угоди чи контакту.',
    ...
    'zh.l4':'Вхід у віджет — за користувачем Zoho: окремих паролів немає.',
    ...
    'f.privacy':'Конфіденційність','f.deletion':'Видалення даних','f.legal':'KL Systems, ФОП · Україна',
  ...
  en: {
    'nav.channels':'Channels','nav.how':'How it works','nav.zoho':'Zoho CRM','nav.price':'Pricing',
    'nav.signin':'Sign in','nav.try':'Try it',
    'hero.badge':'Shared inbox for Zoho CRM',
    'hero.h1a':'Every customer conversation —','hero.h1b':'in one window',
    'hero.lead':'Telegram, Instagram Direct and Messenger arrive in a single inbox. The whole thread sits next to the customer record in Zoho CRM, so nobody has to guess who wrote and what was agreed.',
    ...
    'zh.h':'The thread next to the customer record','zh.lead':'Rozmovio becomes a widget in Zoho CRM. The manager sees the conversation where they already work — on the deal or contact record.',
    ...
    'zh.l4':'Access follows the Zoho user: no separate passwords.',
    ...
    'f.privacy':'Privacy','f.deletion':'Data deletion','f.legal':'KL Systems · Ukraine',

...
export interface OrderField {
  ...
  options: string[];
  /**
   * Подписи к значениям списка, если они отличаются от самих значений.
   *
   * У Zoho значение списка — это и есть его подпись. У Битрикса в поле
   * уезжает номер значения, а человеку показывать номер бессмысленно,
   * поэтому подписи идут рядом.
   */
  titles?: string[];
